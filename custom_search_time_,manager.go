...
func (timeManager *CustomTimeManager) Initialize(remainingTime int64, increment int64, moveTime int64, movesToGo int16, depth uint8, nodeCount uint64) {
...
func (timeManager *CustomTimeManager) StartMoveTimeAllocation(plyNumber uint16) {
...
func (timeManager *CustomTimeManager) ChangeMoveAllocatedTime(newMoveAllocatedTime int64) {
	if timeManager.movesToGo != 0 {
		return
	}
...
func (timeManager *CustomTimeManager) SetMoveTimeIsUp() {
